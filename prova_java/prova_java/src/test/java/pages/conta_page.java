...
public class conta_page {
	 ...
	 * Metodos Criados
	 * 
	 * @autor: Guilherme data:06/04/2019
	 */

	public void guardarPrint(String print) throws IOException {

		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File("C:\\Users\\Brunna\\Documents\\evidencias/" + print));
	}
	...
	public void acessarUrlLogin(String url) throws IOException {
		...
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File("C:\\Users\\Brunna\\Documents\\evidencias/Inserir_Url.png"));
	}
	...
	public void clicarPesquisar() throws IOException {
		...
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File("C:\\Users\\Brunna\\Documents\\evidencias/Clicar_Pesquisa.png"));
	...
	public void inserirPesquisa(String diretor) throws IOException {
		...
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(src, new File("C:\\Users\\Brunna\\Documents\\evidencias/Inseirir_Pesquisa.png"));
